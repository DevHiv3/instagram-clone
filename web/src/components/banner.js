...
function Banner(){
  return (
    <div className="bg-neutral-900 leading-none tracking-tight w-full flex flex-col justify-center items-center px-2 pt-12 bg-gradient-to-b from-black to-neutral-800">
        ...
        <span className="h-16 sm:w-3/5 w-60 text-left text-lg my-16">
        ...
        <div className="flex flex-row justify-center items-center my-20 pb-40">
          <Link href="https://expo.dev/artifacts/eas/kPDwHCgNtvhvWvTbgMhYTJ.apk" target="_blank" rel="noopener noreferrer" className="flex uppercase text-center p-4 mx-4 font-bold text-black bg-white rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-neutral-700 transition-transform duration-200 ease-in-out">
